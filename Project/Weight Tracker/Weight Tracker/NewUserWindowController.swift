...
class NewUserWindowController: NSWindowController, NSTextFieldDelegate {
    ...
    @IBAction func DoneButtonClicked(sender: NSButton) {
        ...
        if userNameErrorDialogOccurred == false {
            ...
            let profileInfoDictionary: NSMutableDictionary = NSMutableDictionary(objects: ["", ["0.0;0.0"], 0, [], [], [0.0, "Mon, 24 Jan 2015"]], forKeys: ["weightUnit", "latestPredictedWeightLoss", "latestPredictedGain/Loss", "weightValues", "weightValueDates", "weightGoal"])
